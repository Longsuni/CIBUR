...
def do_tasks(embs, display=True):
    if display:
        print("Service Calls Prediction: ")
    service_call_label = np.load("./data/data_Chi/serviceCall_counts.npy")

    service_call_mae, service_call_rmse, service_call_r2 = predict_regression(embs, service_call_label, display=display)
    return service_call_mae, service_call_rmse, service_call_r2
